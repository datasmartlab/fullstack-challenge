const messagesEnglish = {
    ...
    /* Filter Product */
    filterProductNameLabel: 'Name',
    filterProductNamePlaceholder: 'Enter product name',
    filterProductPriceLabel: 'Price',
    filterProductPricePlaceholder: 'R$00.00',
    filterProductButton: 'Search',
    ...
    tableProductNoProduct: 'No product found',
    ...
    /* Filter Brand */
    filterBrandNameLabel: 'name',
    filterBrandNamePlaceholder: 'Enter brand name',
    filterBrandButton: 'Search',
